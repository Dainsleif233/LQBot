// edge-functions/lib/tweetnacl.js
// Vendored TweetNaCl (public domain, http://tweetnacl.cr.yp.to/).
// Used for Ed25519 since the EdgeOne edge runtime WebCrypto does not support it.
const __nacl = {};
(function(nacl) {
'use strict';
...
export const nacl = __nacl;
export function signDetached(message, secretKey){ return nacl.sign.detached(message, secretKey); }
